...
<head>
    ...
    <title>Paathshaala - Learn Healthcare & Medical Sciences</title>
...
<body class="font-sans antialiased" style="margin: 0 !important; padding: 0 !important; margin-bottom: 0 !important; background: linear-gradient(135deg, #667eea 0%, #764ba2 50%, #f093fb 100%) !important; height: 100vh !important; background-attachment: fixed !important; overflow-x: hidden !important; max-width: 100vw !important; overflow-y: auto !important;">
    <!-- Navigation -->
    <nav class="fixed w-full top-0 z-50" style="background: rgba(255, 255, 255, 0.98) !important; backdrop-filter: blur(20px) !important; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.1) !important; border-bottom: 1px solid rgba(255, 255, 255, 0.2) !important;">
