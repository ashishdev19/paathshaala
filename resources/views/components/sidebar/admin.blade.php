...
<aside class="w-64 bg-gray-900 text-white min-h-screen">
    <div class="p-6">
        ...
        <nav class="space-y-2">
            ...
            {{-- Teachers --}}
            <a href="{{ route('admin.teachers.index') }}" class="flex items-center space-x-3 px-4 py-3 rounded-lg {{ request()->routeIs('admin.teachers.*') ? 'bg-indigo-600' : 'hover:bg-gray-800' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
