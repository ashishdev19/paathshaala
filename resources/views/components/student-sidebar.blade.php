...
<div class="student-sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <!-- My Courses -->
        <a href="{{ route('student.courses') }}" class="nav-item {{ (request()->routeIs('student.courses') || request()->routeIs('student.courses.index')) ? 'active' : '' }}">
            <i class="fas fa-book icon"></i>
            <span>My Courses</span>
        </a>

        <!-- Browse Courses -->
        <a href="{{ route('student.courses.browse') }}" class="nav-item {{ request()->routeIs('student.courses.browse') ? 'active' : '' }}">
            <i class="fas fa-compass icon"></i>
            <span>Browse Courses</span>
        </a>

        <!-- Live Classes -->
        <a href="{{ route('student.live-classes.index') }}" class="nav-item {{ request()->routeIs('student.live-classes*') ? 'active' : '' }}">
            <i class="fas fa-video icon"></i>
            <span>Live Classes</span>
        </a>

        <!-- Enrollments -->
        <a href="{{ route('student.enrollments.index') }}" class="nav-item {{ request()->routeIs('student.enrollments*') ? 'active' : '' }}">
            <i class="fas fa-clipboard icon"></i>
            <span>Enrollments</span>
        </a>

        <!-- Certificates -->
        <a href="{{ route('student.certificates.index') }}" class="nav-item {{ request()->routeIs('student.certificates*') ? 'active' : '' }}">
