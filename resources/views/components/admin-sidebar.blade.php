<style>
    ...
    /* Roles & Permissions and Admin Accounts use standard styling */
...
<div class="admin-sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('admin.course-categories.index') }}" class="nav-item {{ request()->routeIs('admin.course-categories.*') ? 'active' : '' }}">
        ...
        <a href="{{ route('admin.access-control.index') }}" class="nav-item roles-permissions {{ request()->routeIs('admin.access-control.*') || request()->routeIs('admin.roles.*') || request()->routeIs('admin.permissions.*') ? 'active' : '' }}">
            <i class="fas fa-shield-alt icon"></i>
            <span>Roles & Permissions</span>
        </a>

        <a href="{{ route('admin.accounts.index') }}" class="nav-item admin-accounts {{ request()->routeIs('admin.accounts.*') ? 'active' : '' }}">
