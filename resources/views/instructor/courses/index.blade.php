        ...
        <div class="bg-white rounded-lg shadow p-6">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-semibold text-gray-900">{{ number_format($stats['revenue'] ?? 0) }}</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10 bg-gray-100 rounded flex items-center justify-center overflow-hidden">
                                    <img class="h-10 w-10 rounded object-cover" src="{{ $course->thumbnail_url }}" alt="{{ $course->title }}" onerror="this.style.display='none'; this.parentElement.querySelector('.fallback-icon').style.display='flex';">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                            <a href="{{ route('instructor.courses.show', $course) }}" class="text-blue-600 hover:text-blue-900">View</a>
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                            ...
                            <a href="{{ route('instructor.courses.create.basics') }}" class="mt-4 inline-block bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700">
