...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-600 mt-2">Share your referral code and earn wallet credits when others join!</p>
    </div>
    ...
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 p-6 rounded-lg mb-8 shadow-sm">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    <h3 class="text-lg font-semibold text-blue-900">Current Wallet Balance</h3>
                    <p class="text-blue-700 mt-1">
                        <strong class="text-2xl">₹{{ number_format($wallet->balance, 2) }}</strong>
                    </p>
                </div>
            </div>
            <a href="{{ route('instructor.wallet.index') }}" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-semibold transition-all">
                <i class="fas fa-arrow-right mr-2"></i>View Wallet
            </a>
        </div>
    </div>
    ...
    <div class="bg-gradient-to-br from-teal-600 to-teal-800 rounded-xl shadow-xl p-8 mb-8 text-white">
        <div class="text-center">
            ...
            <p class="text-teal-100 mb-6">Share this code to earn ₹100 wallet credit for each signup!</p>
    ...
    <div class="bg-white rounded-lg shadow-md p-8 mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="text-center">
                ...
                <p class="text-gray-600">Share your unique referral code with colleagues and students.</p>
            </div>
            <div class="text-center">
                <div class="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                    <i class="fas fa-user-plus text-blue-600 text-2xl"></i>
                </div>
                <h3 class="font-semibold text-lg mb-2">2. They Sign Up</h3>
            ...
            <div class="text-center">
                ...
                <h3 class="font-semibold text-lg mb-2">3. Earn Wallet Credits</h3>
                <p class="text-gray-600">When they make their first purchase, ₹100 is added to your wallet!</p>
            </div>
        </div>
        <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p class="text-blue-800">
                <i class="fas fa-info-circle mr-2"></i>
                <strong>Tip:</strong> Use your wallet credits to pay for subscription renewals or withdraw to your bank account!
            </p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-8">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            @if($referral->referred->isInstructor())
                                <span class="px-2 py-1 text-xs font-semibold rounded-full bg-purple-100 text-purple-800">Instructor</span>
                            @else
                                <span class="px-2 py-1 text-xs font-semibold rounded-full bg-blue-100 text-blue-800">Student</span>
                            @endif
                        </td>
        ...
        <div class="text-center py-12">
            ...
            <p class="text-gray-500">Start sharing your referral code to earn wallet credits!</p>
        </div>
        @endif
    </div>
</div>
...
<script>
    ...
    function shareWhatsApp() {
        const text = `Join Medniks as a student or instructor using my referral code ${referralCode} and get ₹100 instant discount! ${shareableLink}`;
        window.open(`https://wa.me/?text=${encodeURIComponent(text)}`, '_blank');
    }

    function shareEmail() {
        const subject = 'Join Medniks and Get ₹100 Discount!';
        const body = `Hi!\n\nI'm inviting you to join Medniks, an amazing learning platform.\n\nUse my referral code: ${referralCode}\nOr click this link: ${shareableLink}\n\nYou'll get ₹100 instant discount!\n\nBest regards`;
