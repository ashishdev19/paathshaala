...
<div class="content-grid">
    ...
    <div style="display: flex; flex-direction: column; gap: 1.5rem;">
        ...
        <div class="section-card">
            ...
            <div style="display: flex; flex-direction: column; gap: 1rem;">
                ...
                <div class="info-item">
                    ...
                    <div class="info-text">{{ $stats['pending_courses'] ?? 0 }} awaiting approval</div>
                </div>
                <div class="info-item">
                    <div class="info-title">Completed Courses</div>
                    <div class="info-text">{{ $stats['completed_courses'] ?? 0 }} courses finished</div>
                </div>
            </div>
        </div>
        ...
        <div class="stats-box">
            ...
            <div class="stats-number">{{ $stats['total_courses'] ?? 0 }}</div>
