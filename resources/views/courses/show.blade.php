...
<head>
    ...
    <title>{{ $course->title }} - {{ config('app.name', 'Medniks') }}</title>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <a href="{{ route('courses.show', $related->id) }}" class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition">
                        @if($related->thumbnail)
                            <img class="h-48 w-full object-cover" src="{{ $related->thumbnail_url }}" alt="{{ $related->title }}">
                        @else
                            <div class="h-48 w-full bg-blue-100 flex items-center justify-center">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <p class="text-gray-300 mb-4">Empowering medical professionals through quality education and training</p>
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li><a href="{{ route('courses.index') }}" class="text-gray-300 hover:text-white transition-colors">Browse Courses</a></li>
