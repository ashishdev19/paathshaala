                    ...
                    <form method="POST" action="{{ route('admin.students.update', $student) }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="phone" class="block mt-1 w-full" type="text" name="phone" :value="old('phone', $student->phone)" autocomplete="tel" />
                            ...
                            <div>
                                ...
                                <x-text-input id="address" class="block mt-1 w-full" type="text" name="address" :value="old('address', $student->address)" autocomplete="street-address" />
                        ...
                        <div class="flex items-center justify-end mt-8 space-x-4">
                            <a href="{{ route('admin.students.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-medium py-2 px-6 rounded-lg transition duration-150 ease-in-out">
                                Cancel
                            </a>
                            <x-primary-button>
                                <i class="fas fa-save mr-2"></i>{{ __('Update Student') }}
                            </x-primary-button>
                        </div>
                    </form>
                </div>
