<x-layouts.admin>
        ...
        <div class="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-lg p-6 border border-indigo-200 shadow-md hover:shadow-lg transition duration-300">
            <div class="flex items-center">
                ...
                <div class="ml-5">
                    ...
                    <p class="text-2xl font-bold text-indigo-600">{{ $stats['total_courses'] ?? 0 }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-6 border border-green-200 shadow-md hover:shadow-lg transition duration-300">
            <div class="flex items-center">
                ...
                <div class="ml-5">
                    ...
                    <p class="text-2xl font-bold text-green-600">{{ $stats['total_students'] ?? 0 }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-lg p-6 border border-yellow-200 shadow-md hover:shadow-lg transition duration-300">
            <div class="flex items-center">
                ...
                <div class="ml-5">
                    ...
                    <p class="text-2xl font-bold text-yellow-600">{{ $stats['total_teachers'] ?? 0 }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-red-50 to-red-100 rounded-lg p-6 border border-red-200 shadow-md hover:shadow-lg transition duration-300">
            <div class="flex items-center">
                ...
                <div class="ml-5">
                    ...
                    <p class="text-2xl font-bold text-red-600">₹{{ number_format($stats['total_payments'] ?? 0) }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="space-y-3">
                <a href="{{ route('admin.courses.create') }}" class="flex items-center p-3 bg-indigo-50 rounded-lg hover:bg-indigo-100 transition">
                ...
                <a href="{{ route('admin.teachers.create') }}" class="flex items-center p-3 bg-green-50 rounded-lg hover:bg-green-100 transition">
        ...
        <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="space-y-3">
                <div class="flex justify-between">
                    ...
                    <span class="font-semibold">{{ $stats['total_enrollments'] ?? 0 }}</span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-600">Pending Payments</span>
                    <span class="font-semibold text-yellow-600">{{ $stats['pending_payments'] ?? 0 }}</span>
                </div>
                <div class="flex justify-between">
                    <span class="text-gray-600">Certificates Issued</span>
                    <span class="font-semibold text-green-600">{{ $stats['certificates_issued'] ?? 0 }}</span>
                </div>
            </div>
        </div>
    </div>
