...
<head>
    ...
    <title>About Us - <?php echo e(config('app.name', 'Medniks')); ?></title>
...
<body class="bg-gradient-to-br from-gray-50 via-white to-gray-50">
    ...
    <div class="relative overflow-hidden bg-blue-600 text-white py-32 pt-40">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <h1 class="text-6xl md:text-7xl font-black mb-8">About <span class="text-white"><?php echo e(config('app.name', 'Medniks')); ?></span></h1>
            ...
            <div class="card-hover bg-white rounded-2xl shadow-xl border">
                <div class="p-8">
                    <div class="w-28 h-28 mx-auto mb-6 bg-blue-600 rounded-full flex items-center justify-center shadow-lg">
                        <span class="text-4xl font-black text-white"><?php echo e(strtoupper(substr($teacher->name, 0, 1))); ?></span>
                    </div>
                    <h3 class="text-2xl font-bold text-gray-900 text-center mb-2"><?php echo e($teacher->name); ?></h3>
                    <p class="text-sm text-gray-500 text-center mb-6"><?php echo e($teacher->email); ?></p>
                    <div class="flex justify-center">
                        <div class="px-4 py-2 rounded-full bg-blue-50 border border-blue-200">
                            <span class="text-sm font-bold text-blue-600"><i class="fas fa-book mr-2"></i><?php echo e($teacher->active_courses_count ?? 0); ?> Courses</span>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\paathshaala\resources\views/shared/public/about.blade.php ENDPATH**/ ?>