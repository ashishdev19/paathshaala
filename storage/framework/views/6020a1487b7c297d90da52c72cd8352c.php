            ...
            <div class="p-6">
                ...
                <div class="mb-4">
                    <div class="flex justify-between text-xs text-gray-600 mb-1">
                        <span>Progress</span>
                        <span><?php echo e($enrollment->progress_percentage ?? 0); ?>%</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2">
                        <div class="bg-blue-600 h-2 rounded-full" style="width: <?php echo e($enrollment->progress_percentage ?? 0); ?>%"></div>
                    </div>
                </div>
                
                <div class="flex items-center justify-between pt-4 border-t border-gray-200">
                    <span class="text-sm text-gray-500">Enrolled: <?php echo e($enrollment->enrolled_at ? $enrollment->enrolled_at->format('M d, Y') : ($enrollment->created_at ? $enrollment->created_at->format('M d, Y') : 'N/A')); ?></span>
                    <a href="<?php echo e(route('courses.show', $course->id)); ?>" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 text-sm">
                        Continue Learning
                    </a>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\paathshaala\resources\views/student/courses/index.blade.php ENDPATH**/ ?>