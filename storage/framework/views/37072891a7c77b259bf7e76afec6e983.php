            ...
            <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-lg shadow p-6 border border-green-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-green-600">₹<?php echo e(number_format($wallet->balance, 2)); ?></p>
                    </div>
            ...
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg shadow p-6 border border-blue-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-blue-600">₹<?php echo e(number_format($stats['total_topup'], 2)); ?></p>
                    </div>
            ...
            <div class="bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg shadow p-6 border border-orange-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-orange-600">₹<?php echo e(number_format($stats['total_spent'], 2)); ?></p>
                    </div>
            ...
            <div class="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-lg shadow p-6 border border-yellow-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-yellow-600">₹<?php echo e(number_format($stats['pending_topups'], 2)); ?></p>
                    </div>
            ...
            <div class="lg:col-span-2">
                ...
                <div class="bg-white rounded-lg shadow p-6 mb-6">
                    ...
                    <div class="flex flex-wrap gap-3">
                        <a href="<?php echo e(route('student.wallet.topup')); ?>" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 font-medium">
                ...
                <div class="bg-white rounded-lg shadow overflow-hidden">
                    ...
                    <?php if($transactions instanceof \Illuminate\Pagination\Paginator && $transactions->hasPages()): ?>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="p-3 border border-gray-200 rounded-lg">
                            <div class="flex justify-between items-start mb-2">
                                <span class="font-semibold text-gray-900">₹<?php echo e(number_format($topup->amount, 2)); ?></span>
                                <span class="px-2 py-1 inline-flex text-xs leading-5 font-semibold rounded-full
                                    <?php if($topup->status === 'completed'): ?> bg-green-100 text-green-800
                                    <?php elseif($topup->status === 'pending'): ?> bg-yellow-100 text-yellow-800
                                    <?php else: ?> bg-red-100 text-red-800 <?php endif; ?>">
                                    <?php echo e(ucfirst($topup->status)); ?>

                                </span>
                            </div>
                            <p class="text-xs text-gray-500"><?php echo e($topup->created_at->format('M d, Y H:i')); ?></p>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                    <?php else: ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\paathshaala\resources\views/student/wallet/index.blade.php ENDPATH**/ ?>