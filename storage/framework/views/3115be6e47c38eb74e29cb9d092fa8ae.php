...
<?php $component->withAttributes([]); ?>
        ...
        <div class="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-lg p-6 border border-indigo-200 shadow-md hover:shadow-lg transition duration-300">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-indigo-600"><?php echo e($categories->total()); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-6 border border-green-200 shadow-md hover:shadow-lg transition duration-300">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-green-600"><?php echo e($categories->where('status', 'active')->count()); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-orange-50 to-orange-100 rounded-lg p-6 border border-orange-200 shadow-md hover:shadow-lg transition duration-300">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-orange-600"><?php echo e($categories->where('status', 'inactive')->count()); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg p-6 border border-purple-200 shadow-md hover:shadow-lg transition duration-300">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-2xl font-bold text-purple-600"><?php echo e($categories->sum('courses_count')); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-lg border border-indigo-100 overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-indigo-100 bg-gradient-to-r from-indigo-50 to-purple-50 flex justify-between items-center">
            ...
            <a href="<?php echo e(route('admin.course-categories.create')); ?>" class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-4 py-2 rounded-lg hover:from-indigo-700 hover:to-purple-700 transition duration-200 shadow-md hover:shadow-lg flex items-center gap-2">
                        ...
                        <tr class="hover:bg-gray-50 transition duration-150">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        ...
                                        <div class="text-xs text-gray-500">ID: #<?php echo e($category->id); ?></div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                <div class="flex items-center justify-center gap-2">
                                    <!-- Toggle Status -->
                                    <form action="<?php echo e(route('admin.course-categories.toggle-status', $category)); ?>" method="POST" class="inline">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('PATCH'); ?>
                                        <button type="submit" class="text-<?php echo e($category->status === 'active' ? 'orange' : 'green'); ?>-600 hover:text-<?php echo e($category->status === 'active' ? 'orange' : 'green'); ?>-900" title="<?php echo e($category->status === 'active' ? 'Deactivate' : 'Activate'); ?>">
                                            <?php if($category->status === 'active'): ?>
                                    ...
                                    <!-- Edit -->
                                    <a href="<?php echo e(route('admin.course-categories.edit', $category)); ?>" class="text-blue-600 hover:text-blue-900" title="Edit">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <!-- Delete -->
                                    <form action="<?php echo e(route('admin.course-categories.destroy', $category)); ?>" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this category?');">
                                        <?php echo csrf_field(); ?>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="4" class="px-6 py-12 text-center">
                                ...
                                <div class="mt-6">
                                    <a href="<?php echo e(route('admin.course-categories.create')); ?>" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\paathshaala\resources\views/admin/course-categories/index.blade.php ENDPATH**/ ?>