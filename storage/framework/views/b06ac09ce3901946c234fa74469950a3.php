...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex justify-between items-center">
            ...
            <a href="<?php echo e(route('instructor.dashboard')); ?>" class="px-4 py-2 border border-indigo-200 rounded-lg text-indigo-700 hover:bg-indigo-50 transition duration-200">
                    ...
                    <div class="p-6">
                        <?php if($currentSubscription): ?>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <!-- Plan Details -->
                                <div>
                                    <h4 class="text-2xl font-bold text-indigo-600 mb-2"><?php echo e($currentSubscription->plan->name); ?></h4>
                                    <p class="text-gray-600 mb-4"><?php echo e($currentSubscription->plan->description ?? 'Premium subscription plan'); ?></p>
                                    ...
                                    <div class="space-y-3 mb-4">
                                        <div>
                                            ...
                                            ?>
                                            <span class="inline-block ml-2 px-3 py-1 rounded-full text-sm font-semibold <?php echo e($statusColors[$currentSubscription->status] ?? 'bg-gray-100 text-gray-800'); ?>">
                                        ...
                                        <div>
                                            <strong>Started:</strong> <?php echo e($currentSubscription->started_at->format('M d, Y')); ?>
                                        ...
                                        <div>
                                            ...
                                            <?php if($currentSubscription->status == 'active'): ?>
                                                <span class="text-green-600 font-semibold"><?php echo e($currentSubscription->expires_at->format('M d, Y')); ?></span>
                                            <?php else: ?>
                                ...
                                <div class="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-lg p-4 border border-indigo-200">
                                    <div class="text-center mb-4">
                                        <span class="text-4xl font-bold text-indigo-600">₹<?php echo e(number_format($currentSubscription->plan->price, 0)); ?></span>
                                        <small class="block text-gray-600">/month</small>
                                        <?php if($currentSubscription->plan->price): ?>
                                            <div class="text-sm text-gray-500 mt-2">
                                                or ₹<?php echo e(number_format($currentSubscription->plan->price * 12, 0)); ?>/year
                                            </div>
                                        <?php endif; ?>
                                    </div>
                                    ...
                                    <ul class="space-y-2">
                                        ...
                                        <?php if($currentSubscription->plan->max_courses): ?>
                                            <li class="flex items-center text-sm">
                                                <i class="fas fa-check text-green-600 mr-2"></i>
                                                <?php echo e($currentSubscription->plan->max_courses); ?> Courses Max
                                            </li>
                                        <?php else: ?>
                                            <li class="flex items-center text-sm">
                                        ...
                                        <?php if($currentSubscription->plan->max_students): ?>
                                            <li class="flex items-center text-sm">
                                                <i class="fas fa-check text-green-600 mr-2"></i>
                                                <?php echo e($currentSubscription->plan->max_students); ?> Students Max
                                            </li>
                                        <?php else: ?>
                                            <li class="flex items-center text-sm">
                            ...
                            <div class="flex gap-2 justify-end mt-6 pt-6 border-t">
                                ...
                                <a href="<?php echo e(route('instructor.subscription.upgrade')); ?>" class="px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg hover:from-indigo-700 hover:to-purple-700 transition duration-200 shadow-md hover:shadow-lg">
                        ...
                        <?php else: ?>
                            ...
                            <div class="text-center py-12">
                                ...
                                <a href="<?php echo e(route('instructor.subscription.upgrade')); ?>" class="inline-block px-6 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg hover:from-indigo-700 hover:to-purple-700 transition duration-200 shadow-md hover:shadow-lg">
                            ...
                            <div class="overflow-x-auto">
                                <table class="w-full text-sm">
                                    ...
                                    <tbody class="divide-y">
                                        <?php $__currentLoopData = $subscriptionHistory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="hover:bg-gray-50">
                                                <td class="px-4 py-3">
                                                    <strong><?php echo e($sub->plan->name ?? 'N/A'); ?></strong>
                                                </td>
                                                <td class="px-4 py-3">
                                                    <?php
                                                        $statusColors = [
                                    ...
                                    $action = $sub->action ?? 'active';
                                                    ?>
                                                    <span class="inline-block px-2 py-1 rounded text-xs font-semibold <?php echo e($statusColors[$action] ?? 'bg-gray-100 text-gray-800'); ?>">
                                                        <?php echo e(ucfirst($action)); ?>

                                                    </span>
                                                </td>
                                                <td class="px-4 py-3"><?php echo e($sub->created_at->format('M d, Y')); ?></td>
                                                <td class="px-4 py-3">
                                                    <?php if($sub->to_plan_id): ?>
                                                        <?php
                                                            $toPlan = \App\Models\SubscriptionPlan::find($sub->to_plan_id);
                                                        ?>
                                                        <?php echo e($toPlan ? $toPlan->name : 'N/A'); ?>
                                                ...
                                                <td class="px-4 py-3 text-green-600 font-semibold">₹<?php echo e(number_format($sub->amount_paid ?? 0, 2)); ?></td>
                                            </tr>
                ...
                <div class="bg-white rounded-lg shadow-lg border border-indigo-100 sticky top-6">
                    ...
                    <div class="p-6 space-y-3">
                        <?php $__currentLoopData = $availablePlans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="border rounded-lg p-4 <?php echo e($currentSubscription && $currentSubscription->plan_id == $plan->id ? 'border-2 border-indigo-600 bg-gradient-to-br from-indigo-50 to-purple-50' : 'border-indigo-100 hover:border-indigo-300 hover:shadow-lg'); ?> transition duration-300">
                                <div class="flex justify-between items-start mb-2">
                                    <h6 class="font-semibold text-gray-800"><?php echo e($plan->name); ?></h6>
                                ...
                                <div class="text-center mb-3">
                                    <div class="text-2xl font-bold text-indigo-600">₹<?php echo e(number_format($plan->price, 0)); ?></div>
                                    <small class="text-gray-600">/month</small>
                                    <div class="text-xs text-gray-500 mt-1">
                                        or ₹<?php echo e(number_format($plan->price * 12, 0)); ?>/year
                                    </div>
                                </div>
                                
                                <p class="text-xs text-gray-600 mb-3"><?php echo e($plan->description ?? 'Premium plan'); ?></p>
                                
                                <ul class="text-xs space-y-1 mb-4">
                                    <?php if($plan->max_courses): ?>
                                        <li class="flex items-center">
                                            <i class="fas fa-check text-green-600 mr-1"></i>
                                            <span>Max <?php echo e($plan->max_courses); ?> Courses</span>
                                        </li>
                                    <?php else: ?>
                                        <li class="flex items-center">
                                    ...
                                    <?php if($plan->max_students): ?>
                                        <li class="flex items-center">
                                            <i class="fas fa-check text-green-600 mr-1"></i>
                                            <span>Max <?php echo e($plan->max_students); ?> Students</span>
                                        </li>
                                    <?php else: ?>
                                        <li class="flex items-center">
                                            <i class="fas fa-infinity text-green-600 mr-1"></i>
                                ...
                                <?php if(!$currentSubscription || $currentSubscription->plan_id != $plan->id): ?>
                                    <div class="w-full">
                                        <a href="<?php echo e(route('instructor.subscription.payment', ['plan' => $plan->id])); ?>" 
                                           class="block w-full text-center px-3 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg hover:from-indigo-700 hover:to-purple-700 text-sm font-semibold transition duration-200 shadow-md hover:shadow-lg">
                                            <?php if($currentSubscription && $plan->price > $currentSubscription->plan->price): ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\paathshaala\resources\views/instructor/subscription/show.blade.php ENDPATH**/ ?>