...
$config = match($role) {
    'admin' => [
        ...
        'menuItems' => [
            ...
            ['label' => 'Instructors', 'route' => 'admin.instructors.index', 'icon' => 'teachers', 'match' => 'admin.instructors.*'],
            ...
            ['label' => 'Subscription', 'route' => 'admin.subscriptions.list', 'icon' => 'subscription', 'match' => 'admin.subscriptions.*'],
            ...
            ['label' => 'Roles & Permissions', 'route' => 'admin.access-control.index', 'icon' => 'settings', 'match' => 'admin.access-control.*|admin.roles.*|admin.permissions.*'],
            ['label' => 'Admin Accounts', 'route' => 'admin.accounts.index', 'icon' => 'settings', 'match' => 'admin.accounts.*'],
