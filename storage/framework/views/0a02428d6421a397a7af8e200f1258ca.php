        ...
        <div class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($stats['professors'] ?? 0); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($stats['students'] ?? 0); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($stats['courses'] ?? 0); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e($stats['enrollments'] ?? 0); ?></p>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 bg-white rounded-lg shadow p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <a href="<?php echo e(route('admin.teachers.index')); ?>" class="p-4 border border-gray-200 rounded hover:bg-gray-50 transition text-center">
                    <div class="text-2xl mb-2">👥</div>
                    <p class="font-medium text-gray-900">Manage Users</p>
                    <p class="text-sm text-gray-500">Professors & Students</p>
                </a>

                <a href="<?php echo e(route('admin.courses.index')); ?>" class="p-4 border border-gray-200 rounded hover:bg-gray-50 transition text-center">
                    <div class="text-2xl mb-2">📚</div>
                    <p class="font-medium text-gray-900">Manage Courses</p>
                    <p class="text-sm text-gray-500">View & Edit</p>
                </a>

                <a href="<?php echo e(route('admin.course-approvals.index')); ?>" class="p-4 border border-gray-200 rounded hover:bg-gray-50 transition text-center">
                    <div class="text-2xl mb-2">✅</div>
                    <p class="font-medium text-gray-900">Course Approvals</p>
                    <p class="text-sm text-gray-500">Pending Review</p>
                </a>

                <a href="<?php echo e(route('admin.subscriptions.list')); ?>" class="p-4 border border-gray-200 rounded hover:bg-gray-50 transition text-center">
                    <div class="text-2xl mb-2">💳</div>
                    <p class="font-medium text-gray-900">Subscriptions</p>
                    <p class="text-sm text-gray-500">Plans & Payments</p>
                </a>

                <a href="<?php echo e(route('admin.wallet.index')); ?>" class="p-4 border border-gray-200 rounded hover:bg-gray-50 transition text-center">
                    <div class="text-2xl mb-2">💰</div>
                    <p class="font-medium text-gray-900">Wallet Management</p>
                    <p class="text-sm text-gray-500">Balance & Withdraw</p>
                </a>

                <a href="<?php echo e(route('admin.reports.index')); ?>" class="p-4 border border-gray-200 rounded hover:bg-gray-50 transition text-center">
                    <div class="text-2xl mb-2">📊</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\paathshaala\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>